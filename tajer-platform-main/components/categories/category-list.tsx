        ...
        {meta && meta.last_page > 1 && (
          <div className="flex flex-col sm:flex-row items-center justify-between p-4 border-t mt-6">
            <div className="flex items-center gap-1">
              ...
              >
                <ChevronLeft className={`h-4 w-4 ${language === 'ar' ? 'rotate-180' : "rotate-0"}`}/>
                {tc('previous')}
              </Button>
              ...
              <div className="flex gap-1 mx-2">
                {getPageNumbers().map((pageNum) => (
                  pageNum === -1 || pageNum === -2 ? (
                    <span key={`ellipsis-${pageNum}`} className="px-2 py-1">...</span>
                  ) : (
                    <Button
                      key={pageNum}
              ...
              >
                {tc('next')}
                <ChevronRight className={`h-4 w-4 ${language === 'ar' ? 'rotate-180' : "rotate-0"}`} />
              </Button>
            </div>
          </div>
        )}
