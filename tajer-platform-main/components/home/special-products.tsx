...
import Toast from "@/app/[locale]/dashboard/settings/toast";
...
export default function SpecialProducts() {
  ...
  const fetchSpecialProducts = async () => {
    try {
      ...
      setProducts(null);
      setToastMessage("حدث خطأ أثناء التحميل يرجى المحاولة مرة أخرى");
    } finally {
      SetLoading(false);
    }
  };
      ...
      <div>
        <div className="text-center mb-10">
          ...
          <p className="mt-2 text-muted-foreground">
            تعرف على أحدث المنتجات المميزة الخاصة بنا
          </p>
        </div>

        <div className="w-[100%] flex items-center flex-col  mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {loading ? (
