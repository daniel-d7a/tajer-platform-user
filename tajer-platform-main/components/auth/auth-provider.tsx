...
export function AuthProvider({ children }: { children: React.ReactNode }) {
  ...
  const validateToken = async (token: string): Promise<{ isValid: boolean; userData?: User }> => {
    try {
      const response = await fetch('https://tajer-backend.tajerplatform.workers.dev/api/auth/me', {
        method: 'GET',
        headers: {
