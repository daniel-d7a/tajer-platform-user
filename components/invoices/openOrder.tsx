...
export default function OpenOrder({ Id, onClose, text_id }: OpenOrderProps) {
  ...
  const download = async () => {
    try {
      ...
      const endpoint =
        downloadFormat === "pdf"
          ? `https://tajer-platform-api.eyadabdou862.workers.dev/api/orders/orders/${Id}/pdf`
          : `https://tajer-platform-api.eyadabdou862.workers.dev/api/orders/orders/${Id}/excel`;
  ...
  const FetchOrderInfo = async () => {
    try {
      const response = await fetch(
        `https://tajer-platform-api.eyadabdou862.workers.dev/api/orders/orders/${Id}`,
        { credentials: "include" }
      );
                      ...
                      return (
                        ...
                        >
                          <div className="flex flex-col sm:flex-row items-center gap-5 w-full sm:w-auto">
                            <div className="relative w-30 h-30 rounded-md overflow-hidden cursor-zoom-in">
                              <Image
