...
import { Boxes, ChevronLeft, ChevronRight, ShoppingBag } from "lucide-react";
...
export default function ProductGrid({
    ...
    const fetchData = async () => {
      try {
        ...
        const fetchData = await fetch(
          `https://tajer-platform-api.eyadabdou862.workers.dev/api/public/products?${categoryParam}&factoryId=${factoryId}&search=${search}&page=${page}&limit=`
        );
  ...
  return (
    <div
      ...
      className="gap-6 w-full px-2 flex flex-col"
    >
